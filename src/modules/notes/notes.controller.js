...
import { createNote,updateNote,replaceNote,updateAllTitles,deleteNote,getNotes, getNoteById,getNoteByContent,getAllNotes,getAggregatedNotes} from "./notes.service.js";
const router=Router()
